<div class="container-fluid px-2 px-sm-3 px-md-4">
    ...
    <div class="page-header-wrapper mb-4">
        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
            <div class="header-title">
                <h1 class="page-title">
                    <span class="title-gradient">Tambah Anggota</span>
                    <span class="title-badge ms-2">Baru</span>
                </h1>
                <p class="title-sub mb-0">Tambahkan anggota baru ekstrakurikuler silat</p>
            </div>
    ...
    <div class="form-card premium-card">
        ...
        <div class="card-body p-3 p-md-5">
            <form action="<?= BASE_URL ?>/anggota/store" method="POST" id="formAnggota" class="premium-form">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-section">
                            ...
                            <div class="section-body">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group premium-input">
                                        ...
                                        <input type="text" class="form-control" id="no_hp" 
                                               name="no_hp" placeholder="081234567890">
                                        <div class="input-focus-bg"></div>
                                    </div>
                                    <div class="form-hint">
                                        <i class="fas fa-info-circle me-1"></i>
                                ...
                                <!-- Hidden Input untuk Tanggal Gabung -->
                                <input type="hidden" name="tanggal_gabung" value="<?= date('Y-m-d') ?>">
                                
                                <!-- BAGIAN INFO CARD PREMIUM TELAH DIHAPUS -->
                            </div>
                        </div>
                    </div>
                </div>
...
$(document).ready(function() {
    ...
    // Auto format input nama (hanya huruf dan spasi)
