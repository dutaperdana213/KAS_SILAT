<div class="container-fluid px-2 px-sm-3 px-md-4">
    ...
    <div class="page-header-wrapper mb-4">
        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center justify-content-between gap-3">
            <div class="header-title">
                <h1 class="page-title">
                    <span class="title-gradient">Edit Kas Masuk</span>
                    <span class="title-badge ms-2">ID: #<?= $kas_masuk['id'] ?></span>
                </h1>
                <p class="title-sub mb-0">Ubah data transaksi pemasukan kas</p>
            </div>
    ...
    <div class="form-card premium-card">
        ...
        <div class="card-body p-3 p-md-5">
            <form action="<?= BASE_URL ?>/kas-masuk/update/<?= $kas_masuk['id'] ?>" method="POST" id="formKasMasuk" class="premium-form">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group premium-input">
                                        ...
                                        <input type="date" class="form-control" id="tanggal" 
                                               name="tanggal" value="<?= $kas_masuk['tanggal'] ?>" required>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group premium-input">
                                        ...
                                        <select class="form-control" id="anggota_id" name="anggota_id" required>
                                            ...
                                            <option value="<?= $a['id'] ?>" <?= $a['id'] == $kas_masuk['anggota_id'] ? 'selected' : '' ?>>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group premium-input">
                                        ...
                                        <input type="text" class="form-control currency-input" 
                                               ...
                                               value="<?= number_format($kas_masuk['jumlah'], 0, ',', '.') ?>" 
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-section">
                            ...
                            <div class="section-body">
                                    ...
                                    <div class="input-group premium-input">
                                        ...
                                        <select class="form-control" id="pertemuan" name="pertemuan" required>
                                            ...
                                            <?php for ($i = 1; $i <= 12; $i++): ?>
                                                <?php 
                                                $selected = '';
                                                if (strpos($kas_masuk['keterangan'], 'ke-' . $i) !== false) {
                                                    $selected = 'selected';
                                                }
                                                ?>
                                                <option value="<?= $i ?>" <?= $selected ?>>Pertemuan ke-<?= $i ?></option>
                                            <?php endfor; ?>
                                        </select>
                                        <div class="input-focus-bg"></div>
                                    </div>
                                ...
                                <!-- Hidden Keterangan -->
                                <input type="hidden" name="keterangan" id="keterangan" value="<?= $kas_masuk['keterangan'] ?>">
                                ...
                                <div class="preview-card mt-4">
                                    ...
                                    <div class="preview-content" id="previewKeterangan">
                                        ...
                                        <span><?= $kas_masuk['keterangan'] ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    // Trigger change untuk set initial preview
    ...
    $('#formKasMasuk').on('submit', function(e) {
        ...
        if (!jumlah || parseInt(jumlah) < 1000) {
